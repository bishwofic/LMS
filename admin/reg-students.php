...
<a href="reg-students.php?id=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to unblock this student?');"><button class="btn btn-primary"> Active</button> 
                                            <?php } ?>
